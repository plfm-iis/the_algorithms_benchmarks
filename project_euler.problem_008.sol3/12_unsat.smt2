...
(assert (> (str.len (str.substr n_VAR 0 (- 13 0))) 0))
(assert (not (str.in.re (ite (str.prefixof "-" (str.at (str.substr n_VAR 0 (- 13 0)) 0)) (str.substr (str.at (str.substr n_VAR 0 (- 13 0)) 0) 1 (str.len (str.at (str.substr n_VAR 0 (- 13 0)) 0))) (str.at (str.substr n_VAR 0 (- 13 0)) 0)) (re.+ (re.range "0" "9")))))
(check-sat)
(get-value (n_VAR))
