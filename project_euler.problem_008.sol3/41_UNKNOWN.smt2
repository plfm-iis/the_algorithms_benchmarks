...
(assert (> (str.len (str.substr n_VAR 0 (- 13 0))) 6))
(assert (str.in.re (ite (str.prefixof "-" (str.at (str.substr n_VAR 0 (- 13 0)) 6)) (str.substr (str.at (str.substr n_VAR 0 (- 13 0)) 6) 1 (str.len (str.at (str.substr n_VAR 0 (- 13 0)) 6))) (str.at (str.substr n_VAR 0 (- 13 0)) 6)) (re.+ (re.range "0" "9"))))
(assert (< 7 (str.len (str.substr n_VAR 0 (- 13 0)))))
(assert (> (str.len (str.substr n_VAR 0 (- 13 0))) 7))
(assert (str.in.re (ite (str.prefixof "-" (str.at (str.substr n_VAR 0 (- 13 0)) 7)) (str.substr (str.at (str.substr n_VAR 0 (- 13 0)) 7) 1 (str.len (str.at (str.substr n_VAR 0 (- 13 0)) 7))) (str.at (str.substr n_VAR 0 (- 13 0)) 7)) (re.+ (re.range "0" "9"))))
(check-sat)
(get-value (n_VAR))
