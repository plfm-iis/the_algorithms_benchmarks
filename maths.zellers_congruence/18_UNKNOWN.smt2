...
(assert (not (= (str.at date_input_VAR 2) "-")))
(assert (= (str.at date_input_VAR 2) "/"))
(assert (> (str.len date_input_VAR) 3))
(assert (> (str.len date_input_VAR) 4))
(assert (str.in.re (ite (str.prefixof "-" (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4))) (str.substr (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4)) 1 (str.len (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4)))) (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4))) (re.+ (re.range "0" "9"))))
(assert (< 0 (ite (str.prefixof "-" (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4))) (- (str.to.int (str.substr (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4)) 1 (str.len (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4)))))) (str.to.int (str.++ (str.at date_input_VAR 3) (str.at date_input_VAR 4))))))
(check-sat)
