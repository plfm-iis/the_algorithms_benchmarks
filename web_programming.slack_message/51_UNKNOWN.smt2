...
(assert (not (< (str.len (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" "")))) 0)))
(assert (not (str.contains (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" ""))) ":")))
(assert (not (< (str.len (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" "")))) 0)))
(assert (not (> (+ 0 (str.indexof (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" ""))) ":" 0)) 0)))
(assert (not (= (str.substr (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" ""))) 0 (- 2 0)) "//")))
(assert (not (str.contains (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" ""))) "#")))
(assert (str.contains (str.++ "" (str.++ "" (str.replaceall (str.++ "" slack_url_VAR) "\r" ""))) "?"))
(check-sat)
