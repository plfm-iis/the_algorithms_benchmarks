...
(assert (not (< (str.len (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) 0)))
(assert (= (+ 0 (str.indexof (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" ""))) "\n" 0)) (- 1)))
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" ""))))) 0)))
(assert (not (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) ":")))
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" ""))))) 0)))
(assert (not (> (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) ":" 0)) 0)))
(assert (not (= (str.substr (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) 0 (- 2 0)) "//")))
(assert (not (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) "#")))
(assert (not (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) "?")))
(assert (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall slack_url_VAR "\t" "")))) ";"))
(check-sat)
