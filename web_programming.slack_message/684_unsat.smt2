...
(assert (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0))
(check-sat)
