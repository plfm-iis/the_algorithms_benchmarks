...
(assert (not (str.contains (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 1)) ";")))
(assert (not (< (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 0)))
