...
(assert (str.contains (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "/"))
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 0)))
(assert (str.contains (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 1 (- (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 1)) ";"))
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 1 (- (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 1)) ";" 0)) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 1 (- (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 1)) ";" 0)) 0)))
(assert (not (< (+ (+ 1 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 1 (- (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 1)) ";" 0)) 1) 0)))
(assert (< (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) 0))
(check-sat)
