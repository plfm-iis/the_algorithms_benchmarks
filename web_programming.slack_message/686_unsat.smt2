...
(assert (not (< (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) (+ (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 1) (- (str.len (str.++ "" (str.++ "" (str.++ "" slack_url_VAR)))) (+ (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 1)))) 0)))
(assert (not (str.contains (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) "?")))
...
(assert (str.contains (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 1)) ";"))
(assert (not (< (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0)))
(assert (not (< (+ (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" slack_url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 1) 0)))
