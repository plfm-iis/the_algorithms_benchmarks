...
(assert (not (< (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) (+ (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 1) (- (str.len (str.++ "" (str.++ "" (str.++ "" url_VAR)))) (+ (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 1)))) 0)))
(assert (not (str.contains (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) "?")))
...
(assert (str.contains (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";"))
(assert (not (< (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0)))
(assert (not (< (+ (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 1) 0)))
(assert (not (< (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 0)))
(assert (not (< (str.len url_VAR) 0)))
(assert (not (str.contains url_VAR "\t")))
(assert (not (< (str.len url_VAR) 0)))
...
(assert (not (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0)))
(assert (not (< (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 0)))
(assert (< (+ (+ 1 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 1 (- (str.len (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0))) 1)) ";" 0)) 1) 0))
(check-sat)
(get-value (url_VAR))
