...
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" ""))))) 0)))
(assert (not (> (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) ":" 0)) 0)))
(assert (not (= (str.substr (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) 0 (- 2 0)) "//")))
(assert (not (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) "#")))
(assert (not (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) "?")))
(assert (not (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) ";")))
(assert (not (< (str.len url_VAR) 0)))
...
(assert (not (< (str.len (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) 0)))
(assert (= (+ 0 (str.indexof (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" ""))) "\n" 0)) (- 1)))
(assert (= (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" ""))))))
(assert (str.contains (str.++ "" (str.++ "" (str.++ "" (str.replaceall url_VAR "\t" "")))) ";"))
(check-sat)
(get-value (url_VAR))
