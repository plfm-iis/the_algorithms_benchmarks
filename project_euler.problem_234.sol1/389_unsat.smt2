...
(assert (not (<= 380 limit_VAR)))
(assert (> 506 limit_VAR))
(assert (> 483 limit_VAR))
(assert (> 460 limit_VAR))
(assert (> 437 limit_VAR))
(assert (> 414 limit_VAR))
(assert (> 391 limit_VAR))
(assert (> 368 limit_VAR))
(assert (not (> 345 limit_VAR)))
