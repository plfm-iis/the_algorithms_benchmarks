...
(assert (< (+ (+ 0 (str.indexof (str.substr (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) 0 (- (+ 0 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.++ "" url_VAR))) "#" 0)) 0)) "?" 0)) 0)) ";" 0)) 1) 0))
(check-sat)
(get-value (url_VAR))
