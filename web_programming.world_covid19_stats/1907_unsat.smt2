...
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" url_VAR)))) 0)))
(assert (>= (+ 2 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 2 (- (str.len (str.++ "" (str.++ "" (str.++ "" url_VAR)))) 2)) "?" 0)) 0))
(assert (< (+ 2 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 2 (- (str.len (str.++ "" (str.++ "" (str.++ "" url_VAR)))) 2)) "?" 0)) (+ 2 (str.indexof (str.substr (str.++ "" (str.++ "" (str.++ "" url_VAR))) 2 (- (str.len (str.++ "" (str.++ "" (str.++ "" url_VAR)))) 2)) "/" 0))))
(assert (not (< (str.len (str.++ "" (str.++ "" (str.++ "" url_VAR)))) 0)))
