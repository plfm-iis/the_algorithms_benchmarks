...
(assert (< 0 (str.len (str.++ (str.++ "" (str.at text_VAR 1)) "A"))))
(assert (> (str.len (str.++ (str.++ "" (str.at text_VAR 1)) "A")) 0))
(assert (> (str.len (str.++ (str.++ "" (str.at text_VAR 1)) "A")) 1))
(assert (> (str.len (str.++ (str.++ "" (str.at text_VAR 1)) "A")) 2))
(check-sat)
(get-value (text_VAR))
