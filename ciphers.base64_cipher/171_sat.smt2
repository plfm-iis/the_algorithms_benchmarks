...
(assert (not (str.contains "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" (str.at text_VAR 4))))
(assert (not (= (str.at text_VAR 4) "=")))
(assert (< 5 (str.len text_VAR)))
(check-sat)
(get-value (text_VAR))
