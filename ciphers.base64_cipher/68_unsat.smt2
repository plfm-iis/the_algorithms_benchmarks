...
(assert (< 0 (str.len (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) (str.at text_VAR 2)) (str.at text_VAR 3)) ""))))
(assert (> (str.len (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) (str.at text_VAR 2)) (str.at text_VAR 3)) "")) 0))
(assert (> (str.len (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) (str.at text_VAR 2)) (str.at text_VAR 3)) "")) 1))
(assert (> (str.len (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) (str.at text_VAR 2)) (str.at text_VAR 3)) "")) 2))
(assert (> (str.len (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) (str.at text_VAR 2)) (str.at text_VAR 3)) "")) 3))
(assert (< 4 (str.len (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) (str.at text_VAR 2)) (str.at text_VAR 3)) ""))))
(check-sat)
(get-value (text_VAR))
