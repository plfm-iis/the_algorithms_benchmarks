...
(assert (< 0 (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) ""))))
(assert (> (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) "")) 0))
(assert (> (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) "")) 1))
(assert (> (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 0)) (str.at text_VAR 1)) "")) 2))
(check-sat)
(get-value (text_VAR))
