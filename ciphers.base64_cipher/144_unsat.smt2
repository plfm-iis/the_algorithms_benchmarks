...
(assert (< 0 (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 1)) (str.at text_VAR 2)) ""))))
(assert (> (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 1)) (str.at text_VAR 2)) "")) 0))
(assert (> (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 1)) (str.at text_VAR 2)) "")) 1))
(assert (> (str.len (str.++ (str.++ (str.++ "" (str.at text_VAR 1)) (str.at text_VAR 2)) "")) 2))
(check-sat)
(get-value (text_VAR))
