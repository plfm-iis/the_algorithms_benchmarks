...
(assert (not (< (+ (* 1 insert_cost_VAR) delete_cost_VAR) (+ 0 replace_cost_VAR))))
(assert (not (< (+ (* 1 delete_cost_VAR) insert_cost_VAR) (+ 0 replace_cost_VAR))))
...
(assert (< (+ (+ 0 replace_cost_VAR) insert_cost_VAR) (+ (* 1 insert_cost_VAR) copy_cost_VAR)))
(check-sat)
