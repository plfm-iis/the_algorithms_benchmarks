...
(assert (not (< 3 (str.len source_string_VAR))))
(assert (< 0 (str.len destination_string_VAR)))
(assert (> (str.len destination_string_VAR) 0))
(assert (not (< 1 (str.len destination_string_VAR))))
...
(assert (= (str.at source_string_VAR 1) (str.at destination_string_VAR 0)))
(assert (not (< (+ (+ 0 copy_cost_VAR) delete_cost_VAR) (+ (* 1 delete_cost_VAR) copy_cost_VAR))))
(assert (not (< (+ (* 2 delete_cost_VAR) insert_cost_VAR) (+ (* 1 delete_cost_VAR) copy_cost_VAR))))
(assert (= (str.at source_string_VAR 2) (str.at destination_string_VAR 0)))
(assert (not (< (+ (+ (* 1 delete_cost_VAR) copy_cost_VAR) delete_cost_VAR) (+ (* 2 delete_cost_VAR) copy_cost_VAR))))
(assert (< (+ (* 3 delete_cost_VAR) insert_cost_VAR) (+ (* 2 delete_cost_VAR) copy_cost_VAR)))
(check-sat)
