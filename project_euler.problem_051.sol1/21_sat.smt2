...
(assert (< 2 (str.len (ite (< number_VAR 0) (str.++ "-" (int.to.str (- number_VAR))) (int.to.str number_VAR)))))
(assert (> (str.len (ite (< number_VAR 0) (str.++ "-" (int.to.str (- number_VAR))) (int.to.str number_VAR))) 2))
(assert (< 3 (str.len (ite (< number_VAR 0) (str.++ "-" (int.to.str (- number_VAR))) (int.to.str number_VAR)))))
(check-sat)
