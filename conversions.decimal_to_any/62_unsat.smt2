...
(assert (= (div (div (div (div (div (div (div (div (div num_VAR base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) 1))
(assert (< (str.len (str.++ "000000000" (ite (< (div (div (div (div (div (div (div (div (div num_VAR base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) 0) (str.++ "-" (int.to.str (- (div (div (div (div (div (div (div (div (div num_VAR base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR)))) (int.to.str (div (div (div (div (div (div (div (div (div num_VAR base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR))))) 0))
(check-sat)
(get-value (num_VAR))
(get-value (base_VAR))
