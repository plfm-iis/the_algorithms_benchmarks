...
(assert (not (not (= (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div (div num_VAR base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) base_VAR) 1))))
(check-sat)
(get-value (num_VAR))
(get-value (base_VAR))
