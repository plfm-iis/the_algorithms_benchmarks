...
(assert (> (str.len equation_VAR) 9))
(assert (not (str.in.re (str.at equation_VAR 9) (re.+ (re.range "0" "9")))))
(assert (not (= (str.at equation_VAR 9) ")")))
(assert (< 10 (str.len equation_VAR)))
(assert (> (str.len equation_VAR) 10))
(assert (not (str.in.re (str.at equation_VAR 10) (re.+ (re.range "0" "9")))))
(assert (not (= (str.at equation_VAR 10) ")")))
(assert (< 11 (str.len equation_VAR)))
(check-sat)
