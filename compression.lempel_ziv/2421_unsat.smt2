...
(assert (not (not (= (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ (str.++ "" (str.at data_bits_VAR 0)) (str.at data_bits_VAR 1)) (str.at data_bits_VAR 2)) (str.at data_bits_VAR 3)) (str.at data_bits_VAR 4)) (str.at data_bits_VAR 5)) (str.at data_bits_VAR 6)) (str.at data_bits_VAR 7)) (str.at data_bits_VAR 8)) (str.at data_bits_VAR 9)) ""))))
(check-sat)
