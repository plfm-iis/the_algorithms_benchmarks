...
(assert (> (str.len n_VAR) 12))
(assert (str.in.re (ite (str.prefixof "-" (str.at n_VAR 12)) (str.substr (str.at n_VAR 12) 1 (str.len (str.at n_VAR 12))) (str.at n_VAR 12)) (re.+ (re.range "0" "9"))))
(check-sat)
(get-value (n_VAR))
