...
(assert (= (mod (div (div (div (div (div (div (div (div (div n_VAR 2) 2) 2) 3) 3) 5) 5) 5) 5) 5) 0))
(assert (not (= (mod (div (div (div (div (div (div (div (div (div (div n_VAR 2) 2) 2) 3) 3) 5) 5) 5) 5) 5) 5) 0)))
(assert (not (<= 36 (div (div (div (div (div (div (div (div (div (div n_VAR 2) 2) 2) 3) 3) 5) 5) 5) 5) 5))))
(assert (> (div (div (div (div (div (div (div (div (div (div n_VAR 2) 2) 2) 3) 3) 5) 5) 5) 5) 5) 1))
(check-sat)
(get-value (n_VAR))
