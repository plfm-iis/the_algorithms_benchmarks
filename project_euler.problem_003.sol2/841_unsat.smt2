...
(assert (not (= (mod (div (div n_VAR 2) 5) 5) 0)))
(assert (<= 36 (div (div n_VAR 2) 5)))
(assert (not (= (mod (div (div n_VAR 2) 5) 6) 0)))
(assert (not (<= 49 (div (div n_VAR 2) 5))))
(assert (not (> (div (div n_VAR 2) 5) 1)))
(check-sat)
(get-value (n_VAR))
