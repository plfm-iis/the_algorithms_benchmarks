...
(assert (= (mod (div (div (div (div (div (div (div n_VAR 2) 2) 3) 5) 5) 7) 7) 7) 0))
(assert (not (= (mod (div (div (div (div (div (div (div (div n_VAR 2) 2) 3) 5) 5) 7) 7) 7) 7) 0)))
(assert (not (<= 64 (div (div (div (div (div (div (div (div n_VAR 2) 2) 3) 5) 5) 7) 7) 7))))
(assert (> (div (div (div (div (div (div (div (div n_VAR 2) 2) 3) 5) 5) 7) 7) 7) 1))
(check-sat)
(get-value (n_VAR))
