...
(assert (not (< 1 (str.len (str.substr (str.++ "" (str.++ "" (str.replaceall (str.++ "" (str.++ "https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=" bbc_news_api_key_VAR)) "\r" ""))) 0 (- (+ 0 (str.indexof (str.++ "" (str.++ "" (str.replaceall (str.++ "" (str.++ "https://newsapi.org/v1/articles?source=bbc-news&sortBy=top&apiKey=" bbc_news_api_key_VAR)) "\r" ""))) ":" 0)) 0))))))
(check-sat)
