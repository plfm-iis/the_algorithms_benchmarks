...
(assert (< 3 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 3))
(assert (str.in.re (str.at expression_str_VAR 3) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z")))))
(assert (< 4 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 4))
(assert (str.in.re (str.at expression_str_VAR 4) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z")))))
(assert (< 5 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 5))
(assert (str.in.re (str.at expression_str_VAR 5) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z")))))
(assert (< 6 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 6))
(assert (str.in.re (str.at expression_str_VAR 6) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z")))))
(assert (< 7 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 7))
(assert (str.in.re (str.at expression_str_VAR 7) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z")))))
(assert (< 8 (str.len expression_str_VAR)))
(check-sat)
