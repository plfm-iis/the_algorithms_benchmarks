...
(assert (not (< 6 (str.len expression_str_VAR))))
(assert (< 0 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 0))
...
(assert (< 4 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 4))
(assert (not (str.in.re (str.at expression_str_VAR 4) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z"))))))
(assert (not (str.in.re (str.at expression_str_VAR 4) (re.+ (re.range "0" "9")))))
(assert (not (= (str.at expression_str_VAR 4) "(")))
(assert (not (= (str.at expression_str_VAR 4) ")")))
(assert (< 5 (str.len expression_str_VAR)))
(assert (> (str.len expression_str_VAR) 5))
(assert (not (str.in.re (str.at expression_str_VAR 5) (re.+ (re.union (re.range "A" "Z") (re.range "a" "z"))))))
(assert (not (str.in.re (str.at expression_str_VAR 5) (re.+ (re.range "0" "9")))))
(assert (not (= (str.at expression_str_VAR 5) "(")))
(assert (= (str.at expression_str_VAR 5) ")"))
(check-sat)
